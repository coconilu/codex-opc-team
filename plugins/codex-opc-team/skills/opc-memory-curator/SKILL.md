...
1. Resolve the skill directory as the directory containing this `SKILL.md`, then resolve the plugin root as `<skill-dir>/../..`; read `references/promotion-policy.md`, `references/relation-and-migration-policy.md`, and `references/python-runtime.md`.
