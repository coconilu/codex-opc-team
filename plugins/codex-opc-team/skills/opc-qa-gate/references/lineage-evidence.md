...
2. Require exact Packet/Trace version+hash for every claimed injected revision and exact role/step identity.
...
5. Resolve QA/feedback/outcome/shadow/evaluation refs to existing bounded single-link `.opc` files; do not accept copied prose.
