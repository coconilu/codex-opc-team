...
| 阶段 | 状态 | 目标 |
|---|---|---|
| R0 开源基础 | 本地候选 | 干净仓库、Marketplace、文档、安全迁移和回滚基线 |
| R1 v0.1 核心闭环 | 本地候选 | Codex 原生团队、File/Git 记忆、独立 QA |
| R2 v0.1 可选 Mem0 | 本地候选 | 可引导安装、可降级、可卸载的 OSS Adapter |
| R3 v0.1 发布 | 发布候选 | Windows/Linux CI、固定标签安装和 Release |
...
- 经验候选的重放、Shadow Evaluation 和置信度变化；
- 跨项目冲突检测、适用范围推断和失效提示；
